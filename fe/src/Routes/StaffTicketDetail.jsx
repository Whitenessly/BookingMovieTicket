...
const StaffTicketDetail = () => {
    ...
    React.useEffect(() => {
        fetch(`http://localhost:8080/ticket/details/${ticketParam.id}`)
                ...
                <div className='w-screen h-screen'>
                    ...
                    <div className='w-full fixed -z-10 top-0 p-6 pt-18'>
                        <div className='border-2 border-gray-200 w-full h-full shadow-2xl rounded-2xl p-6 flex flex-col gap-8'>
                            <div className='text-xl'><span className='font-bold'>Ticket:</span> {ticket._id}</div>
                            <div className='flex flex-col gap-1'>
                                <div className='text-xl'><span className='font-bold'>Name:</span> {ticket.userId.userName}</div>
                                <div className='text-xl'><span className='font-bold'>Email:</span> {ticket.userId.email}</div>
                            </div>
                            <div className='flex flex-col gap-1'>
                                <div className='text-xl'><span className='font-bold'>Title:</span> {ticket.movieId.title}</div>
